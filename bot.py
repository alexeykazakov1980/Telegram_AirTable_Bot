...
def register_handlers(
    *,
    ...
    async def callback_finish(callback_query: types.CallbackQuery):
        ...
        "Благодарность, связь с гидом:\n"
        "+79163150546 (Альфа-банк) 🅰️\n\n"
        "Все ссылки на группы, каналы и социальные сети проекта - https://iqtours.ru/social, "
        "подписывайтесь удобным Вам способом и будем на связи!\n"
        "@NebanalnoMsk"                )
            )
        except Exception as e:
